"""
Módulo de processamento de áudio e vídeo.
Inclui funções para identificar formato de vídeo e extrair áudio para transcrição.
Utiliza ffmpeg e ffprobe para manipulação dos arquivos.
"""
...
def get_format_from_video(video_path: str) -> str:
    ...
    Retorno:
        str: Formato detectado (ex: 'mp4', 'mkv').
...
def extract_audio_from_video(video_path: str, audio_format: str = "mp3") -> str:
    """
    Extrai o áudio de um vídeo e salva em arquivo temporário.
    Parâmetros:
        video_path (str): Caminho do arquivo de vídeo.
        audio_format (str): Formato do áudio de saída (default: mp3).
    Retorno:
        str: Caminho do arquivo de áudio extraído.
    Lança Exception em caso de erro ou formato não suportado.
    """
